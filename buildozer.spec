...
requirements = pyjnius, deep-translator, mpmath==0.19, setuptools-scm, Pillow, numpy, tzdata, jnius, sqlparse, oscpy, kivy, django==5.0.7, bs4, beautifulsoup4, chardet, idna, urllib3, asgiref, regex, six, soupsieve, sh, colorama, toml, charset_normalizer, roman, pytz, django-cors-headers, python-dateutil, yt-dlp, pandas, matplotlib, alquran-id, langdetect
